$(document).ready(function () {
  ...
  // $(".icon_tab ul li:nth-child(2)").next().addClass("changed");
  ...
  //설명 슬라이드 제목넣기
  $(".Regi > .swiper-pagination span").eq(0).html("<p>로그인</p>");

  $(".Regi > .swiper-pagination span").eq(1).html("<p>방문업체<br>정보입력</p>");

  $(".Regi > .swiper-pagination span").eq(2).html("<p>관련서류<br>첨부</p>");

  $(".Regi > .swiper-pagination span").eq(3).html("<p>업체등록<br>신청</p>");

  $(".Regi > .swiper-pagination span").eq(4).html("<p>신청결과<br>대기</p>");

  $(".Regi > .swiper-pagination span").eq(5).html("<p>정보등록<br>완료</p>");
});
